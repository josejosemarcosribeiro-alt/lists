...
router.get('/register-step1', (req, res) => {
    res.render('register'); // seu register.pug que só pede email
});
...
router.get('/register-step2', (req, res) => {
    ...
    res.render('register-password'); // seu register-password.pug
});
...
router.get('/register-step3', (req, res) => {
    ...
    res.render('register-name'); // seu register-name.pug
});
